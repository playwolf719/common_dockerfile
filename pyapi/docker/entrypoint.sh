...
# if NGINX_WORKER_CONNECTIONS exists then modify nginx.conf
...
# if NGINX_WORKER_OPEN_FILES exists then modify nginx.conf
...
mkdir -p /var/log/qa_data_job
mkdir -p /data/qademo_prod
